...
p1=float(input("Digite o preço unitário do produto 2: "))
q1=int(input("Digite a quantidade do produto 2: "))
total += q1*p1
input("Digite o nome do produto 3: ")
p1=float(input("Digite o preço unitário do produto 3: "))
q1=int(input("Digite a quantidade do produto 3: "))
total += q1*p1
